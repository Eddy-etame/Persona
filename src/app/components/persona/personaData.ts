...
export const PERSONA_TEMPLATES: Record<string, Partial<Persona>> = {
  ...
  "ynov-etudiant-dev": {
    role: "Étudiant",
    type: "L'étudiant développeur (projet & alternance)",
    occupation: "Étudiant Bachelor Informatique",
    studyLevel: "Bac+2",
    program: "Bachelor Informatique (parcours Développement / Cloud)",
    yearOfStudy: "2ème année",
    campus: "Paris Est",
    neighborhood: "Val d'Europe",
    housing: "Colocation - secteur Marne-la-Vallée",
    transportation: "RER A + bus (trajet variable selon projets/campus)",
    arriveTime: "9h00",
    departTime: "18h30",
    workSchedule: "Projets en demi-journées + ateliers / sprints",
    favoriteSpots: "Open-space projets, bibliothèque, cafés proches du campus",
    studentId: "YNOV-2024-DEV-0421",
    enrollmentDate: "Septembre 2024",
    scholarshipStatus: "Non boursier",
    partTimeJob: "Freelance web (missions ponctuelles)",
    bio: "Inès, 20 ans, étudiante en Bachelor Informatique. Elle vit au rythme des sprints projets, hackathons et rendus. Elle gère ses cours, ses livrables, et ses candidatures alternance depuis son téléphone. Elle accepte les outils, tant qu'ils sont rapides, cohérents et qu'ils évitent les doubles saisies.",
    personality: "Curieuse, très autonome, orientée produit, sensible au détail UX, impatiente face aux outils incohérents",
    maritalStatus: "Célibataire",
    children: "Aucun",
    nationality: "Française",
    languages: "Français (natif), Anglais (C1 technique)",
    hobbies: "Side projects, UI kits, gaming casual, meetups tech",
    sports: "Salle 2x/semaine",
    values: "Autonomie, progression, efficacité, transparence",
    fears: "Perdre du temps sur l'administratif, rater une opportunité d'alternance",
    deepMotivations: "Construire un portfolio solide et obtenir une alternance en product/dev",
    stressLevel: "Élevé en période de rendu (8/10), modéré sinon (4/10)",
    stressManagement: "To-do lists, sprints courts, sport, musique",
    sleepSchedule: "Variable (rendus)",
    introExtrovert: "Ambivert (6/10)",
    morningOrNight: "Plutôt soir",
    techSavvy: "Expert - développe et déploie régulièrement",
    devices: "iPhone, PC portable Windows, second écran",
    apps: "Notion, GitHub, Discord, Google Calendar, Slack",
    digitalTools: "GitHub, VS Code, Docker, Postman, Notion, Trello",
    whyKeyce: "Pédagogie par projets, campus multi-villes, spécialisation tech, alternance possible dès la 3ème année",
    primarySystemNeeds:
      "Planning temps réel\nNotifications cohérentes\nAccès rapide aux consignes & livrables\nSuivi alternance (conventions, documents)\nCentralisation des infos scolarité",
    frequentTasks:
      "Consulter planning (plusieurs fois/jour)\nVérifier changements salles/intervenants\nTélécharger consignes\nDéposer livrables\nSuivre documents alternance",
    timeSpentOnSystem: "15-25 min/jour, 8-12 connexions",
    systemUsage: "Mobile 70% / Laptop 30%",
    goals:
      "Avoir un planning fiable\nÊtre notifiée des changements immédiatement\nNe plus chercher les documents dans 3 outils\nSoumettre un livrable en 2 clics\nSuivre facilement l'alternance",
    frustrations:
      "Infos dispersées par filière/outils\nTrop de doubles saisies\nNotifications incomplètes\nDocs difficiles à retrouver\nErreurs de planning",
    needs:
      "Une app mobile vraiment rapide\nUn tableau de bord centralisé\nSSO\nRecherche globale\nHistorique clair (traçabilité)",
    quote:
      "Je suis OK avec beaucoup d'outils… tant qu'ils sont cohérents. Là, j'ai l'impression de courir après l'info.",
    idealFeature: "Timeline 'Aujourd'hui' : planning + tâches + livrables + docs, au même endroit",
    dealBreaker: "Pas de mobile, pas de notifications, ou des infos contradictoires selon l'outil",
    onboardingExpectation: "Onboarding en 3 minutes + checklists selon mon profil + aide contextuelle",
  },
  "ynov-enseignant-pro": {
    role: "Enseignant",
    type: "L'intervenant professionnel multi-campus",
    occupation: "Intervenant / Mentor",
    position: "Intervenant Dev / Cloud",
    department: "Informatique",
    contractType: "Intervenant (vacations)",
    teachingHours: "8-12h/semaine (variable)",
    subjectsTaught: "Développement web, API, Cloud & déploiement, bonnes pratiques",
    bio: "Karim, 34 ans, intervenant pro en développement et cloud. Il intervient sur 2 campus selon les promos. Il a besoin d'un planning fiable, de salles confirmées, et d'un espace unique pour déposer supports, récupérer les rendus et publier les résultats sans friction.",
    personality: "Direct, organisé, orienté résultats, tolérance faible aux bugs",
    transportation: "Transports + voiture selon campus",
    workSchedule: "Interventions + mentoring + réunions de jurys",
    devices: "MacBook + iPhone",
    apps: "Teams/Meet, Notion, GitHub, Drive",
    techSavvy: "Expert",
    primarySystemNeeds:
      "Planning et salles fiables\nDépôt supports\nCollecte rendus\nÉvaluation & publication\nCommunication ciblée aux étudiants",
    frustrations:
      "Changements planning tardifs\nDonnées étudiants dispersées\nDépôts de livrables non standardisés\nOutils multiples par campus",
    needs:
      "Un espace 'Cours du jour'\nRappels automatiques\nExport facile\nAccès mobile tablette\nHistorique des évaluations",
    quote: "Je veux enseigner, pas faire de l'administration pendant une heure après chaque cours.",
  },
  "ynov-admin-scolarite": {
    role: "Administration",
    type: "La coordinatrice scolarité & alternance (réseau)",
    occupation: "Coordination Scolarité / Alternance",
    position: "Coordinatrice Scolarité & Alternance",
    department: "Scolarité",
    bio: "Camille, 41 ans, coordonne scolarité et alternance. Elle gère conventions, pièces, relances, jurys et attestations. Son enjeu principal est la traçabilité multi-campus et la réduction des exports manuels.",
    personality: "Rigoureuse, orientée process, aime les tableaux de bord",
    emailsPerDay: "60-120",
    meetingsPerWeek: "6-10",
    timeSpentOnSystem: "3 à 5 heures / jour",
    systemUsage: "100% ordinateur",
    techSavvy: "Avancé",
    primarySystemNeeds:
      "Traçabilité des démarches\nWorkflows alternance\nDocuments & signatures\nReporting réseau\nAlertes seuils & anomalies",
    frustrations:
      "Données éparpillées\nRelances manuelles\nReporting lent\nPeu de standardisation entre campus\nErreurs de saisie",
    needs:
      "Workflows guidés\nExports/BI\nRôles & permissions\nAudit log\nTemplates documents",
    quote: "Si je peux fiabiliser l'alternance et supprimer les exports manuels, je gagne une journée par semaine.",
  },
  "enseignant": {
